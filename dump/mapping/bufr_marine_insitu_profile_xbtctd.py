...
MAPPING_PATH = map_path('bufr_marine_insitu_profile_xbtctd.yaml')


class MarineInsituProfileXbtctdObsBuilder(MarineInsituObsBuilder):
    ...
    def make_obs(self, comm, input_path):
        ...
        self._add_error_var(container, "waterTemperature", 0.12)
        self._add_error_var(container, "salinity", 1.0)
        self._add_seq_num(container)

        return container

add_main_functions(MarineInsituProfileXbtctdObsBuilder)
