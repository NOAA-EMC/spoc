...
MAPPING_PATH = map_path('bufr_marine_insitu_surface_cstgd.yaml')


class MarineInsituSurfaceCstgdObsBuilder(MarineInsituObsBuilder):
    ...
    def make_obs(self, comm, input_path):
        ...
        self._add_error_var(container, "seaSurfaceTemperature", 0.24)

        return container

add_main_functions(MarineInsituSurfaceCstgdObsBuilder)
