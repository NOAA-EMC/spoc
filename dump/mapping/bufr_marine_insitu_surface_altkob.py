...
MAPPING_PATH = map_path('bufr_marine_insitu_surface_altkob.yaml')


class MarineInsituSurfaceAltkobObsBuilder(MarineInsituObsBuilder):
...
add_main_functions(MarineInsituSurfaceAltkobObsBuilder)
