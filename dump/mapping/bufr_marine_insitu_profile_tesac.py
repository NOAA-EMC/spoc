...
MAPPING_PATH = map_path('bufr_marine_insitu_profile_tesac.yaml')


class MarineInsituProfileTesacObsBuilder(MarineInsituObsBuilder):
    ...
    def make_obs(self, comm, input_path):
        ...
        id_mask = np.array([True if id.isdigit() and id != 0 else False for id in station_id])
...
add_main_functions(MarineInsituProfileTesacObsBuilder)
