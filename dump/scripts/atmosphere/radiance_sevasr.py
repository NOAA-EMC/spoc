...
class BufrSevasrObsBuilder(ObsBuilder):
    ...
    def compute_sensor_channel_number(self, nlocs, nchannels):
        ...
        where each row is [4, 5, ..., nchannels].
        ...
        """
        return np.tile(np.arange(4, nchannels + 1, dtype=np.int32), (nlocs, 1))
    ...
    def make_obs(self, comm, input_path):
        ...
        for cat in container.all_sub_categories():
            ...
            nchannels = 11  # Number of channels
            # Add Eight Channels from 4 to 11
...
add_main_functions(BufrSevasrObsBuilder)
